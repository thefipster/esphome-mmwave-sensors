...
You can change the name of the `header` directory in home assistant if it doesn't apply to your naming scheme. You can adjust the file locations via substitutions.
...
Take a look at the yaml files in the `example` directory, these should give you a basic understanding of what to do when you create a new device in ESPHome.
